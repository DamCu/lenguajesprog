...
const Lenguajes = () => {
  return (
    <div>
     <p>Aquí te mostraremos algunos de los lenguajes mas utilizados durante este año</p>
     
<h5>1. Python</h5>
<div class="text-center">
  <img src="/py.jpg" class="rounded" height="250"/>
</div>
<p> Número de trabajos: 19,000
...
Python se utiliza en una amplia variedad de aplicaciones, incluida la inteligencia artificial, los servicios financieros y la ciencia de datos. Paginas de redes sociales como Instagram y Pinterest también se basan en Python.</p>
<br></br>

<h5>2. JavaScript</h5>
<div class="text-center">
  <img src="/js.jpg" class="rounded" height="250"/>
</div>
<p>Número de trabajos: 24,000
...
JavaScript se usa ampliamente en el desarrollo de sitios web y aplicaciones móviles. Node.js permite el desarrollo de aplicaciones basadas en navegador, que no requieren que los usuarios descarguen una aplicación.</p>


<br></br>
<h5>3. Java</h5>
<div class="text-center">
  <img src="/jv.jpg" class="rounded" height="250"/>
</div>
<p>Número de trabajos: 29,000
...
Junto con las aplicaciones comerciales, Java se usa ampliamente en el sistema operativo móvil Android.</p>


<br></br>
<h5>4. C#</h5>
<div class="text-center">
  <img src="/cs.jpg" class="rounded" height="250"/>
</div>
<p>Número de trabajos: 18,000
...
C# es el lenguaje de referencia para el desarrollo de aplicaciones de Microsoft y Windows. También se puede usar para dispositivos móviles y consolas de videojuegos usando una extensión de .NET Framework llamada Mono.</p>


<br></br>
<h5>5. C++</h5>
<div class="text-center">
  <img src="/cm.jpg" class="rounded" height="250"/>
</div>

<p>Número de trabajos: 9,000
...
C++ tiene muchos usos y es el lenguaje detrás de todo, desde juegos de computadora hasta simulaciones matemáticas.</p>


<br></br>
<h5>6.PHP</h5>
<div class="text-center">
  <img src="/ph.jpg" class="rounded" height="250"/>
</div>
<p>Número de trabajos:7,000
...
PHP es el código que ejecuta sitios web orientados al contenido como Facebook, WordPress y Wikipedia.</p>
